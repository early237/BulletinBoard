...
<div class="container">    
  <div class="row">
        <div class="panel-body">
            ...
            <h1>View Boards</h1>
            <h2>Here you can see all the boards other users have created! Find and select one you find interesting. </h2>
                    ...
                    <table>
                        <tr style="font-family:Arial, Helvetica, sans-serif;font-size:12pt;">
                            ...
                            <td style="width:100px;background-color:#f0f0f0;">
                                <asp:Label ID="Title_Label" runat="server" Text=""></asp:Label>
                            </td>
                            ...
                            <td style="width:100px;;background-color:#f0f0f0;">
                                <asp:Label ID="Time_Label" runat="server" Text=""></asp:Label>
                            </td>
